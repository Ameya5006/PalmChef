...
const Home: React.FC = () => (
  ...
  >
    ...
    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-500 via-sky-400 to-indigo-500 px-6 py-16 text-white shadow-lg">
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-start gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link
            to="/recipes"
            className="rounded-md bg-white px-6 py-3 text-sm font-semibold text-slate-900 shadow-md transition hover:-translate-y-0.5 hover:bg-slate-100"
          >
            Start cooking
          </Link>
          <Link
      ...
      <div className="pointer-events-none absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-0 left-1/3 h-72 w-72 rounded-full bg-indigo-300/30 blur-3xl" />
      </div>
    </section>
    ...
    <section className="grid gap-6 lg:grid-cols-3">
      ...
      <div className="grid gap-6 lg:col-span-2 lg:grid-cols-2">
        {featureHighlights.map(feature => (
          <div
            key={feature.title}
            className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 dark:border-slate-800 dark:bg-slate-900"
          >
    ...
    <section className="grid gap-8 rounded-3xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900/40 lg:grid-cols-2">
      <div>
